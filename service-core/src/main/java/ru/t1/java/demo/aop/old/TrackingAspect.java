package ru.t1.java.demo.aop.old;
...
public class TrackingAspect {
    ...
    @Before("@annotation(ru.t1.java.demo.aop.old.Track)")
    ...
    @After("@annotation(ru.t1.java.demo.aop.old.Track)")
    ...
    @Around("@annotation(ru.t1.java.demo.aop.old.Track)")
